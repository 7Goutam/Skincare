...
<div className="flex flex-col items-center md:items-start text-center md:text-left px-4 md:px-12 max-w-md w-full">
  ...
  {/* Shop Now Button */}
  <div className="hidden lg:flex mt-99">
    <button className="bg-gray-800 text-white w-[180px] h-[60px] text-[20px] rounded-full">
      Shop Now
        ...
        <div className="block sm:hidden -my-15">
        <h1 className="text-[80px] font-extrabold font-inter leading-[1] tracking-tighter uppercase text-[#2d3b36] opacity-90 text-center whitespace-nowrap z-0 ">
          SKINCARE
        </h1>
      </div>
      ...
      <div className="md:hidden lg:hidden mt-10 flex justify-center">
        <button className="bg-gray-800 text-white w-[180px] h-[60px] text-[20px] rounded-full">
          Shop Now
        </button>
      </div>
