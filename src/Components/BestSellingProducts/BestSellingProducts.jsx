            ...
            >
              <div className="relative w-full h-full">
                ...
                <div className="absolute bottom-4 left-4 right-4 bg-[#F9FBEF] rounded-[12px] px-4 py-4 flex items-center justify-between shadow-md">
                  ...
                  <button className="bg-[#2D3B361A] opacity-90 w-[50px] h-[50px] sm:w-[60px] sm:h-[60px] flex items-center justify-center rounded-lg">
                    <FiShoppingCart size={22} className="text-[#1A1A1A]" />
                  </button>
                </div>
              </div>
            </div>
              ...
              >
                <div className="relative w-full h-full">
                  ...
                  <div className="absolute bottom-4 left-4 right-4 bg-[#F9FBEF] rounded-[12px] px-4 py-4 flex items-center justify-between shadow-md">
                    ...
                    <button className="bg-[#2D3B361A] opacity-90 w-[50px] h-[50px] flex items-center justify-center rounded-lg">
                      <FiShoppingCart size={22} className="text-[#1A1A1A]" />
                    </button>
                  </div>
                </div>
